            ...
            <div className={Style.accordion}>
                  ...
                  <details className={Style.accordionItem}>
                    ...
                    <div className={Style.accordionContent}>
                      <p>
                        Please RSVP by 06/20/2026 so we can finalize all arrangements. You can RSVP online or by returning the card included.
                      </p>
                    </div>
                  </details>
                  ...
                  <details className={Style.accordionItem}>
                    ...
                    <div className={Style.accordionContent}>
                      <p>
                          ...
                          Should you wish to offer a gift, monetary contributions toward our new journey together would be 
